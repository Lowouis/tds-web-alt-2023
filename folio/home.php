<section class="start" id="start" >
    ...
    <h1>LOUIS GURITA</h1>
    <h4>Apprenti Developpeur Application & Support IT chez<a id="sap" href="https://www.sap.com/france/index.html" target="_blank">SAP LABS.</a></h4>
    ...
    <a class="gh-btn btn hover fade "  href="#a propos"><i class="fa-solid fa-arrow-down"></i></a>
</section>