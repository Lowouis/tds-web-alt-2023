<section id="projets" class="article-menu cat">
    ...
    <div id="navbar-works" class="grid-1-4 card-glass">
        <nav>
            ...
            <a class="netflix ab fade transparent-border">Netflix Clone</a>
            <a class="bw ab fade transparent-border">Boat War</a>
            <a class="city ab fade transparent-border">City Generator</a>
        </nav>
