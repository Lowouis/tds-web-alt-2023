...
class PHPMailer
{
     ...
     * the HTML refers to using the `$cid` value in `img` tags, for example `<img phpmailer_src="cid:mylogo">`.
     * Never use a user-supplied path to a file!
     *
     * @param string $path        Path to the attachment
     ...
     * $basedir is prepended when handling relative URLs, e.g. <img phpmailer_src="/images/a.png"> and must not be empty
    ...
    {
        preg_match_all('/(?<!-)(phpmailer_src|background)=["\'](.*)["\']/Ui', $message, $images);
